...
def extract_dictionary_from_ai_string(ai_string):
    ...
    Args:
    generated_string (str): The string generated by GPT-4o which includes unwanted characters or code.
