...
def ai_gene_list(cell_type, tissue=None):
    """
    ...
    # Prepare the prompt
    if len(cell_type) == 1:
        base_prompt = f"In a few words and without restating any part of the question, describe the single most likely cell type represented by the marker gene: {cell_type[0]}"
    else:
        genes_str = "    ".join(cell_type)
